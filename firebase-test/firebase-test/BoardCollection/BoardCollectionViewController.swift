...
class BoardCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    var boards = [
        Board(title: "Todo", items: ["Test", "Schema Design", "Kamehameha", "Bleh bleh bleh"]),
        Board(title: "In Progress", items: ["bao bede", "eddie", "ching chong"]),
        Board(title: "Done", items: ["pig1", "Pig 2"])
    ]
